...
def car_registration():
  return render_template('/form_carreg.html',tab_id="1")
...
def car_search():
  ...
  if len(search_customer) <= 3 or search_customer['search'] == "" :
    print("1")
    return render_template('/form_carreg.html',search_customer="",tab_id="2")
  else:
    print("2")
    ...
    if db_car_search(search_customer) == None:
      ...
      print(search_customer)
      return render_template('/form_carreg.html',search_customer=search_customer,tab_id="2")

@app_car.route('/forms/car_detail/<id>')
@login_required
def car_detail(id):
  searched_account=detail_car(id)
  return render_template('/form_carreg.html',searched_account=searched_account,tab_id="3")

@app_car.route('/forms/new_car/edit')
@login_required
def car_edit():
  user_car=edit_car()
  return render_template('/form_carreg.html',user_car=user_car,tab_id="4")
