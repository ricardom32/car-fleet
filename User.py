...
class User(UserMixin):
  def __init__(self, id, email_admin, branch, email, password,first_name, last_name, valid, reservation_main, reservation_reg, reservation_detail, customer_main, customer_reg, customer_detail, maintenance_main, maintenance_reg, maintenance_detail, car_main, car_reg, car_detail, team_main, team_reg, team_detail, employee_main, employee_reg, employee_detail, expenses_main, expenses_reg, expenses_detail, view_plan):
    ...
    self.expenses_main = expenses_main
    self.expenses_reg = expenses_reg
    self.expenses_detail = expenses_detail
