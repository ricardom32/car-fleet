...
def db_new_team(data):
  ...
  if check_user != 0:
    ...
    with engine.connect() as conn:
      query = text("INSERT INTO accounts_admin (email_admin, branch, email, password, first_name, last_name, date_birth, mobile, gender, address, complements, city, state,coutry, zipcode, valid, reservation_main, reservation_reg, reservation_detail, customer_main, customer_reg, customer_detail, maintenance_main, maintenance_reg, maintenance_detail, car_main, car_reg, car_detail, team_main, team_reg, team_detail, employee_main, employee_reg, employee_detail, expenses_main, expenses_reg, expenses_detail, view_plan) VALUES (:email_admin, :branch, :email, :password, :first_name, :last_name, :date_birth, :mobile, :gender, :address, :complements, :city, :state, :coutry, :zipcode, :valid, :reservation_main, :reservation_reg, :reservation_detail, :customer_main, :customer_reg, :customer_detail, :maintenance_main, :maintenance_reg, :maintenance_detail, :car_main, :car_reg, :car_detail, :team_main, :team_reg, :team_detail, :employee_main, :employee_reg, :employee_detail, :expenses_main, :expenses_reg, :expenses_detail, :view_plan)")
